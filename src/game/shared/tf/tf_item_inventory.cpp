...
#ifdef CLIENT_DLL
CON_COMMAND_F( cl_reload_item_schema, "Reload the item schema from items_game.txt and items_custom.txt on the client", FCVAR_CLIENTDLL )
{
...
#else
CON_COMMAND_F( sv_reload_item_schema, "Reload the item schema from items_game.txt on the server", FCVAR_GAMEDLL )
{
